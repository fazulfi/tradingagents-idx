...
def _get_overall_bias(accum: dict, distrib: dict, smf: dict, pnd: dict) -> tuple:
...
def get_idx_market_intelligence(
    ...
    bias, reasoning = _get_overall_bias(accum, distrib, smf, pnd)
    sections.append(
